...
public class IntakeSubsystem extends SubsystemBase implements SmartSubsystem{
  ...
  public IntakeSubsystem() {
    m_solenoidArm = new Solenoid(PneumaticsModuleType.CTREPCM, RobotMap.kIntakeArmSolenoid);
    m_solenoidBase = new Solenoid(PneumaticsModuleType.CTREPCM, RobotMap.kIntakeBaseSolenoid);
